...
__DEFINE__(1645785265288, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1645785265289,"./event-store":1645785265290}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645785265289, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1645785265290, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1645785265289,"./utils":1645785265291}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645785265291, function(require, module, exports) {
...
return __REQUIRE__(1645785265288);
})()
